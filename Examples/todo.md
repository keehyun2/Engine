...
**예제 목록**:
- [ ] bacva - BA-CVA (Book Value Adjustment for CVA)
- [ ] sacva - SA-CVA (Standardized Approach CVA)
- [ ] xva_explain - XVA 속성 설명
- [ ] xva_sensi - XVA 민감도
- [ ] xva_stress - XVA 스트레스 테스트
- [ ] xva_corr - XVA 상관관계 분석
- [ ] ccs - 통화간 스왑 XVA
- [ ] equity - 주식 XVA
- [ ] flipview - XVA Flip View
- [ ] fx - 외환 XVA
- [ ] hw2f - Hull-White 2요인 XVA
- [ ] longterm - 장기 XVA
