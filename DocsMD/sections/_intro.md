...
<a href="#tab_coverage" data-reference-type="ref"
data-reference="tab_coverage">1</a>.
...
See section <a href="#example:orepython" data-reference-type="ref"
data-reference="example:orepython">[example:orepython]</a> on how to use
ORE-Python.
...
an overview over the core ORE data flow in section
<a href="#sec:process" data-reference-type="ref"
data-reference="sec:process">[sec:process]</a> and installation
instructions in section
<a href="#sec:installation" data-reference-type="ref"
data-reference="sec:installation">[sec:installation]</a> we start in
section <a href="#sec:examples" data-reference-type="ref"
data-reference="sec:examples">[sec:examples]</a> with a series of
examples that illustrate how to launch ORE using its command line
application, and we discuss typical results and reports.
